...
### 时区（重要坑）
- **runtime metadata 的 timestamp = host 机器的 EDT 时间（真实 EDT，UTC-4）**
- **需要 +12h 换算**才能得到孔吉当地时间（SGT / 北京时间，UTC+8）
  - EDT 10:29 metadata = UTC 14:29 = **SGT / 北京时间 22:29**（晚上）
  - EDT 08:20 metadata = UTC 12:20 = **SGT / 北京时间 20:20**（晚上）
  - EDT 01:35 metadata = UTC 05:35 = **SGT / 北京时间 13:35**（中午）
- **绝对要**给 metadata 时间 +12h ——它是真实 EDT，不是孔吉当地时间
- 详细证据链 + 元教训见 `.learnings/LEARNINGS.md` LRN-20260612-001
- ~~LRN-20260611-001 是错的——把孔吉"我这边是早上"**字面事实**误判为反讽/盘问，反推出了"metadata = 北京时间"的反向结论~~


## 待跟进

- ~~**孔吉生日 6-11 中午 12:15 cron 触发时补个更用心的祝福**~~：**已过期** —— 6-11 不是生日（6-12 才是），6-12 中午 12:15 cron 已触发并发了生日祝福（见 2026-06-12.md），待跟进删除
